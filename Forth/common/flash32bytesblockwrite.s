...
@ Emulation for hflash! to circumvent problems with 32-Byte-ECC Flash
@ 32-Bit Flash writes are collected here to be written later as 32 Byte blocks

@ Einfügen im Hauptteil:  
@ .equ Sammelstellen, 32 @ 32 * (32 + 4) = 1152 Bytes
@ ramallot Sammeltabelle, Sammelstellen * 36 @ Buffer 32 blocks of 8 bytes each for ECC constrained Flash write
...
@ -----------------------------------------------------------------------------
  @ Idee: Prüfe, ob der 32-Byte-Block gerade in der Tabelle ist.
  @ Wenn ja: Einfügen, und falls es der 16. Schreibzugriff ist, weiterleiten.
  @ Wenn nein: Neuen 32-Byte-Block eröffnen und mit $FF füllen - Achtung, Tabellenüberlauf !
