...
void MX_QUADSPI_Init(void)
{
  ...
  hqspi.Init.ClockPrescaler = 60; // ?? 1
  hqspi.Init.FifoThreshold = 4;
  hqspi.Init.SampleShifting = QSPI_SAMPLE_SHIFTING_HALFCYCLE;
  hqspi.Init.FlashSize = 23; // (24 bit for 16 MiB) -1
...
void HAL_QSPI_MspInit(QSPI_HandleTypeDef* qspiHandle)
{
  ...
  */
    ...
    PG6     ------> QUADSPI_BK1_NCS
    */
    GPIO_InitStruct.Pin = QS_D2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF9_QUADSPI;
    HAL_GPIO_Init(QS_D2_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = QS_CLK_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF9_QUADSPI;
    HAL_GPIO_Init(QS_CLK_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = QS_D0_Pin|QS_D1_Pin|QS_D3_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF9_QUADSPI;
    ...
    GPIO_InitStruct.Pin = QS_CS_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF10_QUADSPI;
    HAL_GPIO_Init(QS_CS_GPIO_Port, &GPIO_InitStruct);
...
void HAL_QSPI_MspDeInit(QSPI_HandleTypeDef* qspiHandle)
{
  ...
  /* USER CODE END QUADSPI_MspDeInit 0 */
    ...
    PG6     ------> QUADSPI_BK1_NCS
    */
    HAL_GPIO_DeInit(QS_D2_GPIO_Port, QS_D2_Pin);

    HAL_GPIO_DeInit(QS_CLK_GPIO_Port, QS_CLK_Pin);

    HAL_GPIO_DeInit(GPIOD, QS_D0_Pin|QS_D1_Pin|QS_D3_Pin);

    HAL_GPIO_DeInit(QS_CS_GPIO_Port, QS_CS_Pin);
