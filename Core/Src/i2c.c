...
void MX_I2C3_Init(void)
{
  ...
  hi2c3.Instance = I2C3;
  hi2c3.Init.Timing = 0x00707CBB; // 100 kHz standard
  // hi2c3.Init.Timing = 0x00300F38; // 400 kHz fast
  // hi2c3.Init.Timing = 0x00100413; // 1 MHz kHz fast plus
...
void HAL_I2C_MspInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  */
    ...
    PB11     ------> I2C3_SDA
    */
    GPIO_InitStruct.Pin = MEMS_SCK_Pin|MEMS_SDA_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    ...
    /* I2C3 DMA Init */
    /* I2C3_RX Init */
    hdma_i2c3_rx.Instance = DMA1_Channel6;
    ...
    /* I2C3_TX Init */
    hdma_i2c3_tx.Instance = DMA1_Channel7;
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  /* USER CODE END I2C3_MspDeInit 0 */
    ...
    PB11     ------> I2C3_SDA
    */
    HAL_GPIO_DeInit(MEMS_SCK_GPIO_Port, MEMS_SCK_Pin);
