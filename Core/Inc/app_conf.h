...
#define MECRISP_CUBE_VERSION "Mecrisp-Cube 1.3.5 for STM32WB55, 63/128 KiB RAM/FLASH dictionary (C) 2020 peter@spyr.ch\n"
...
#define CFG_HRS_PROCESS_STACK_SIZE            (512 * 4)
