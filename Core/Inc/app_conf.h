...
#define MECRISP_CUBE_VERSION "Mecrisp-Cube 1.4.1 for STM32WB55, 63/128 KiB RAM/FLASH dictionary (C) 2020 peter@spyr.ch\n"
...
#define CFG_SHCI_USER_EVT_PROCESS_STACK_SIZE  (192 * 8)
